...
class _SharingPageState extends State<SharingPage> {
  ...
  void _onShare(BuildContext context) async {
    ...
    final maps = Uri.https("google.com", "/maps/search/", { "api=1&query": "100,100" });
    print(maps.data);
    final box = context.findRenderObject() as RenderBox?;
    
    //Para probar el envío de cards
    ///*
    final dir = await getTemporaryDirectory();
    final byte = (await rootBundle.load("assets/pdfs/pdf-test.pdf")).buffer.asUint8List(); // convert in to Uint8List
